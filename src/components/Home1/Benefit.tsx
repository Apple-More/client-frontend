                ...
                <div className={`benefit-block ${props}`}>
                    <div className="list-benefit grid items-start lg:grid-cols-4 grid-cols-2 gap-[30px]">
                        ...
                        <div className="benefit-item flex flex-col items-center justify-center">
                            ...
                            <div className="heading6 text-center mt-5">Shipping island-wide</div>
                            <div className="caption1 text-secondary text-center mt-3">We ship our products island-wide, making them accessible to customers everywhere.</div>
                        </div>
                    </div>
                </div>
            </div>
